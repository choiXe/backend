...
function pastDataUrl(stockId, count, option) {
    return (
        'https://fchart.stock.naver.com/sise.nhn?requestType=0&symbol=' +
        stockId +
        '&count=' +
        count +
        '&timeframe=' +
...
function investorUrl(stockId) {
    return (
        'https://m.stock.naver.com/api/stock/' + stockId + '/trend?pageSize=31'
    );
}
...
function naverWiseUrl(stockId) {
    return (
        ...
        'v2/company/c1010001.aspx?cmp_cd=' +
        stockId
    );
}
...
function naverFinancialUrl(stockId) {
    return (
        'https://navercomp.wisereport.co.kr/' +
        'company/chart/c1030001.aspx?frq=Y&cmp_cd=' +
        stockId
    );
}
...
function wiseReportUrl(stockId) {
    return (
        ...
        'company/cF1002.aspx?finGubun=MAIN&frq=0&cmp_cd=' +
        stockId
    );
}
...
function hankyungUrl(pageNum) {
    return (
        ...
        'apps.analysis/analysis.list?skinType=business&pagenum=' +
        pageNum
    );
}
