...
const url =
    'http://consensus.hankyung.com/apps.analysis/analysis.list?skinType=business&pagenum=200';
...
async function getSectorInfo(stockId) {
    let sBody;
    const sUrl =
        'https://finance.daum.net/api/quotes/A' +
        stockId +
        '?summary=false&changeStatistics=true';
